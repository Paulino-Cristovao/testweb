# Generated by Django 4.2.21 on 2025-05-28 11:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('citizen', 'Citizen'), ('staff', 'Embassy Staff'), ('admin', 'Administrator')], max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nationality', models.CharField(default='Mozambican', max_length=100)),
